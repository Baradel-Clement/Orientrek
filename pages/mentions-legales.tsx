...
const MentionsLegales: NextPageWithLayout<Props> = () => {
  ...
  return (
    <>
      <NextSeo
        title="Mentions Légales - Orientrek"
        ...
        <section className="PageMentions">
          ...
          <div className="PageMentions-container">
            ...
            <p className="margintop">
              ...
              www.orientrek.com. En consultant les pages de ce site internet,
              vous vous engagez à les respecter sans réserve.
            </p>
            <p className="heading bold margintop">1 – Informations légales</p>
            <p className="margintop">
              Le responsable de la publication du site internet est : <br />
              Samuel Bernard, domicilié 14 rue Louis Jasseron à Lyon 3ème
              (69003) <br />
            ...
            <p className="margintop">
              ...
              domicilié 340 S Lemon Ave #4133 Walnut, CA 91789. Leur téléphone
              est le +1 559-288-7060.
            </p>
            ...
            <p className="margintop">
              ...
              reproduction, intégrale ou partielle, réalisée sans le
              consentement d'Orientrek est illicite et constitue une contrefaçon
              sanctionnée pénalement par les lois internationales. Les contenus,
              logos, photos et images présentés sur ce site internet sont la
              propriété d'Orientrek, ou de leurs auteurs et ayant droits
              respectifs. La loi n'autorise que des copies ou reproductions
              réservées à un usage privé et non destinées à une utilisation
              commerciale ou collective. Il est formellement interdit de
              collecter et d'utiliser les informations disponibles sur ce site à
              des fins commerciales. La violation d'une de ces dispositions
              soumet le contrevenant et toutes personnes responsables, aux
              peines pénales et civiles prévues par la loi sur la protection du
              droit d'auteur dans tous les états signataires de la convention de
              Berne. <br />
              La majorité des photos visibles sur le site internet ont été
              prises par la communauté Orientrek et elle en conserve la
              propriété. Certaines photos ont également été achetées sur la
              banque d'image iStock.
            </p>
            ...
            <p className="margintop">
              ...
              nécessaires pour répondre à sa demande et sont destinées à
              l’éditeur du site. <br />
            ...
            <p className="margintop">
              Ce site utilise Google Analytics, un service d’analyse du trafic
              de site internet fourni par Google Inc. (« Google »). Google
              Analytics utilise des cookies , qui sont des fichiers textes
              hébergés sur votre ordinateur, pour aider le site internet à
              analyser l’utilisation du site par ses utilisateurs. Les données
              générées par les cookies concernant votre utilisation du site (y
              compris votre adresse IP) sont transmises et stockées par Google
              sur des serveurs situés aux Etats-Unis. Google utilise ces
              information dans le but d’évaluer l’utilisation du site par ses
              visiteurs, de compiler des rapports sur l’activité du site à
              destination de son éditeur et de fournir d’autres services
              relatifs à l’activité du site et à l’utilisation d’Internet.
              ...
              pour le compte de Google, y compris notamment l’éditeur de ce
              site. Google s’engage à ne jamais recouper votre adresse IP avec
              toute autre donnée détenue par Google. Vous pouvez désactiver
              l’utilisation de cookies en sélectionnant les paramètres
              ...
              site. En acceptant l'usage de cookies sur notre site, vous
              acceptez que Google traite des données vous concernant de la
              manière et aux fins décrites ci-dessus.
            </p>
          </div>
        </section>
      </Layout>

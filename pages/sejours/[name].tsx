...
const Séjour: NextPageWithLayout<Props> = ({ currentSejour }: Props) => {
  ...
  return (
    <>
      <NextSeo
        title={`Trek ${
          currentSejour.trek === "Couleurs d'automne" ? "aux" : "au"
        } ${currentSejour.trek}`}
            ...
            <div className="sejour-header">
              <div className="sejour-header-left">
                ...
                <div className="embla-desktop">
                  <div
                    className="embla-desktop__viewport"
                    ref={emblaRefDesktop}
                  >
                    <div className="embla__container">
        ...
        {currentRoadmapFullscreen !== 0 && (
          <>
            <div className="PageSejour-fullscreenImg">
              ...
              />
              <button onClick={() => setCurrentRoadmapFullscreen(0)}>
                <Image src={closeIcon} alt="icone fermeture" />
              </button>
              <Image
